...
public class MusicService extends MediaBrowserServiceCompat {
    ...
    private static final String TAG = "12345678";
    ...
    public void onLoadChildren(@NonNull String parentId, @NonNull final Result<List<MediaBrowserCompat.MediaItem>> result) {
        ...
        for (int i = 0; i < 20; i++) {
            MediaMetadataCompat metadata = new MediaMetadataCompat.Builder()
                    .putString(MediaMetadataCompat.METADATA_KEY_MEDIA_URI, "http://5.595818.com/2015/ring/000/140/6731c71dfb5c4c09a80901b65528168b.mp3")
